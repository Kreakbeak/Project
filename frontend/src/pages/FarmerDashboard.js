          ...
          <>
            ...
            <div style={{ 
              ...
              >
                ...
                <p style={{ fontSize: '0.85rem', color: '#666', margin: '0.5rem 0 0 0' }}>All reports view</p>
              </div>
            </div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                      <thead>
                        <tr style={{ backgroundColor: '#f3f4f6', borderBottom: '2px solid #e5e7eb' }}>
                          ...
                          <th style={{ padding: '0.75rem', textAlign: 'left' }}>Identified As</th>
                        ...
                        {getFilteredReports().map((report, idx) => {
                          ...
                          return (
                            <tr key={idx} style={{ borderBottom: '1px solid #e5e7eb' }}>
                              ...
                              <td style={{ padding: '0.75rem' }}>
                                <button 
                                  onClick={() => navigate(`/farmer/report/${report._id}`)}
                                  style={{
            ...
            {stats.reportsByCrop && stats.reportsByCrop.length > 0 && (
              <div className="report-card" style={{ marginBottom: '2rem' }}>
                <h3>🌾 Your Reports by Crop Type</h3>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '1rem' }}>
                  {stats.reportsByCrop.map((crop, idx) => (
                    <div key={idx} style={{ padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '6px', border: '1px solid #e2e8f0' }}>
                      ...
                      <p style={{ margin: '0.5rem 0 0 0', fontSize: '1.3rem', fontWeight: '700', color: '#0f172a' }}>{crop.count}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div style={{ marginTop: '2rem' }}>
          ...
          <div style={{ marginTop: '1rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
            <div className="report-card">
              ...
              <Link to="/farmer/submit-report"><button style={{ backgroundColor: '#3b82f6', color: 'white', padding: '0.5rem 1rem', borderRadius: '4px', border: 'none', cursor: 'pointer' }}>Submit Report</button></Link>
            </div>
            <div className="report-card">
              <h3>📊 View My Reports</h3>
              <p>Track the status of all your submitted reports. View recommendations from agricultural experts.</p>
              <Link to="/farmer/my-reports"><button style={{ backgroundColor: '#3b82f6', color: 'white', padding: '0.5rem 1rem', borderRadius: '4px', border: 'none', cursor: 'pointer' }}>View Reports</button></Link>
            </div>
            <div className="report-card">
              ...
              <Link to="/farmer/library"><button style={{ backgroundColor: '#3b82f6', color: 'white', padding: '0.5rem 1rem', borderRadius: '4px', border: 'none', cursor: 'pointer' }}>View Library</button></Link>
            </div>
          </div>
        </div>
      </div>
